        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            setVideoContent(e) {
                ...
                if ("hosted" === e.videoType) {
                    ...
                    "yes" === e.autoplay ? (n.attr("allow", "autoplay"),
                    n.attr("src", i.getAutoplayURL(e.url))) : n.attr("src", e.url)
                }
            ...
            getSlideshowHeader() {
                ...
                if (n || i || o || l) {
                    ...
                    if (o) {
                        ...
                        i.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(s.zoomOutBold.element).attr(o).addClass(a.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (i) {
                        ...
                        d.$iconExpand = t(n).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen),
                        i.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(s.frameMinimize.element).attr(o).addClass(a.hidden).on("click", this.toggleFullscreen),
